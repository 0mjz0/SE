    ...
    public partial class FrmMoneyReport : Form
    {
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkDate.Checked)
                {
                    db.GetMoneyReportByDate(ref Cost1, ref Cost2, ref Sale, ref Buy, ref Doc1, ref Doc2, mskDate1.Text, mskDate2.Text);
                }
                else
                {
                    db.GetMoneyReportByYear(ref Cost1, ref Cost2, ref Sale, ref Buy, ref Doc1, ref Doc2, mskYear.Text);
                }
